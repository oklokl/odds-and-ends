...
class MetronomeService : Service() {
    ...
    override fun onCreate() {
        ...
        acquireWakeLock()
        flashManager = FlashManager(this)   // ← 추가
        // ▼ 진동 초기화
    ...
    fun startMetronome() {
        ...
        val intervalMs = (quarterNoteMs * (4.0 / unit)).toLong()
    ...
    private fun playBeat() {
        ...
        if (state.isVibrationMode) {
            ...
            if (isStrongBeat) {
                ...
                // ★ 강박 플래시 설정이 켜져 있으면 플래시도 같이
                if (isFlashOnStrongBeatEnabled()) {
                    flashManager?.pulse()
                }
            } else {
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setOngoing(state.isPlaying)  // 재생 중일 때만 고정
            .setSilent(true)
            .build()
    }
