...
class MetronomeService : Service() {
    ...
    fun startMetronome() {
        ...
        metronomeStartElapsedMs = android.os.SystemClock.elapsedRealtime()
        lastNotificationUpdate = 0L   // 바로 00:00:00이 보이도록 초기화
    ...
    private fun createNotification(): Notification {
        ...
        val statusText = if (state.isPlaying) {
            val base = if (metronomeStartElapsedMs != 0L) {
                android.os.SystemClock.elapsedRealtime() - metronomeStartElapsedMs
            } else {
                0L
            }
            ...
            val hours: Long = totalMinutes / 60          // Long 사용
