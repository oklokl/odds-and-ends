    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (timerPaused && pausedRemain > 0L) {
            ...
            val i = Intent(context, ClockService::class.java).apply {
                Intent.setAction = "com.krdonon.timer.action.START_TIMER"
            ...
            val pauseIntent = Intent(context, ClockService::class.java).apply {
                Intent.setAction = "com.krdonon.timer.action.PAUSE_TIMER"
            }
            ...
            val i = Intent(context, ClockService::class.java).apply {
                Intent.setAction = "com.krdonon.timer.action.KEEP_ALIVE"
            }
            ContextCompat.startForegroundService(context, i)
        }
        ...
        if (swRunning && swBase > 0L) {
            ...
            val i = Intent(context, ClockService::class.java).apply {
                Intent.setAction = "com.krdonon.timer.action.START_STOPWATCH"
