...
class TimerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        parentFragmentManager.setFragmentResultListener("numberPadResult", viewLifecycleOwner) { _, bundle ->
            ...
            AppLog.i(requireContext(), "TimerFragment", "numberPadResult targetAt=$targetAt duration=$dur now=${System.currentTimeMillis()}")
            when {
    ...
    private fun startMainFromRemain(remain: Long) {
        ...
        AppLog.i(requireContext(), "TimerFragment", "startMainFromRemain remain=$remain endAt=$endAt")
    }

    private fun startMain() {
        val remain = pendingMainTargetAtMs?.let { targetAt ->
        ...
        timeLeftInMillis = remain
        AppLog.i(requireContext(), "TimerFragment", "startMain remain=$remain pendingTargetAt=$pendingMainTargetAtMs")
