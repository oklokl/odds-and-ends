...
class WeekdayAlarmService : Service() {
    ...
    companion object {
        ...
        private var instance: WeekdayAlarmService? = null

        fun handleNotificationDismissed(context: Context, alarmId: Long, label: String) {
            instance?.onNotificationDismissed(alarmId, label)
        }
    }
    ...
    private var isRingingNow = false
    ...
    fun onNotificationDismissed(alarmId: Long, label: String) {
        if (isRingingNow) {
    ...
    private fun buildRingingNotification(alarmId: Long, label: String): Notification {
        ...
        val stopIntent = Intent(this, WeekdayAlarmService::class.java).apply {
            action = ACTION_STOP
        }
        ...
        val deleteIntent = Intent(this, com.krdonon.timer.NotificationDismissReceiver::class.java).apply {
            action = com.krdonon.timer.NotificationDismissReceiver.ACTION_DISMISS_ALARM_WEEKDAY
            putExtra(com.krdonon.timer.NotificationDismissReceiver.EXTRA_ALARM_ID, alarmId)
