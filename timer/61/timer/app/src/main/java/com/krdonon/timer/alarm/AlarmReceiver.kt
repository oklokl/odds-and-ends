...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        AppLog.i(context, "AlarmReceiver", "received label=${intent.getStringExtra(AlarmService.EXTRA_LABEL)} endAt=${intent.getLongExtra(ClockService.EXTRA_TIMER_END_AT_WALL, -1L)} alarmId=${intent.getLongExtra(AlarmScheduler.EXTRA_ALARM_ID, -1L)}")
