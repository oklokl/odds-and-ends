...
class ClockService : Service() {
    ...
    companion object {
        ...
        // ✅ 알림 자동 묶음(auto-grouping) 방지용 그룹 키(각 기능별로 분리)
        //   - 메인 타이머 / 스톱워치 / 보조 타이머가 한 덩어리로 접히지 않도록 한다.
        private const val TIMER_GROUP = "main_timer_group"
        private const val STOPWATCH_GROUP = "stopwatch_group"
        private const val STOPWATCH2_GROUP = "stopwatch2_group"
