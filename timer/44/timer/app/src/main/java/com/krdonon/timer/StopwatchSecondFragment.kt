...
class StopwatchSecondFragment : Fragment() {
    ...
    /** DDD:HH:MM:SS.mmm (예: 000:00:00:00.000) */
    private fun formatTime(ms: Long): String {
        ...
        // days는 3자리로 고정 (000~999). 999를 넘어가면 그대로 출력
        val dStr = if (days <= 999) String.format("%03d", days) else days.toString()
        return String.format("%s:%02d:%02d:%02d.%03d", dStr, hours, minutes, seconds, millis)
    }
}
